SELECT * FROM tHF_WOExItemToolsSml
SELECT * FROM vHF_WOEx
SELECT * FROM vHF_WOExSetsItem
SELECT * FROM tHE_SetSubjContact
SELECT * FROM tHF_WOExItemToolsSml
SELECT * FROM tHF_WOExItemToolsSml
SELECT * FROM tHF_WOExItemToolsSml
SELECT * FROM tHF_WOExItemToolsSml
...
SELECT acKey FROM tHE_SetItem
where acName like '%oper%'

SELECT * FROM tHE_SetItem
where acDocTypeProd LIKE '%6%'

SELECT * FROM tHE_SetItem
where acSetOfItem='700'

SELECT * FROM vHF_SetPrst
where acSetOfItem='400' or acSetOfItem='300'
...
SELECT anPriceSupp FROM tHE_SetItem 
where  acIdent LIKE 'W%'
...
SELECT * FROM tHE_SetItem where acIdent LIKE 'W%' 
SELECT acident, acname, acDescr, anRTPrice, acUM, acPurchCurr FROM tHE_SetItem where acIdent LIKE 'W%' 
